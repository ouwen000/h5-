...
Page({
  data: {
    ...
    // 图片更新信息
    now: Date.now(),
    imgUrl: 'https://wenfree.cn/api/Public/idfa_xianyu/?service=Wey.Img_'
  },
  ...
  scrollTouchend:function(e){
    ...
    } else if (d.endy > 0 && d.endy - d.starty < -this.data.critical && d.scrollindex < this.data.totalnum - 1){
      console.log("向上翻页");
      this.setData({
        scrollindex: d.scrollindex+1
      })
